...
prompt
prompt # EXECUTE JOB GATHER_CUSTOM_STALE_STATS_JOB
EXEC DBMS_SCHEDULER.RUN_JOB('GATHER_CUSTOM_STALE_STATS_JOB'); 

prompt
prompt # EXECUTE JOB GATHER_CUSTOM_FULL_STATS_JOB
EXEC DBMS_SCHEDULER.RUN_JOB('GATHER_CUSTOM_FULL_STATS_JOB');
