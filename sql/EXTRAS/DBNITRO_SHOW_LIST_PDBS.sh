...
col "SIZE(MB)" FORMAT 9,999.990 HEADING 'SIZE(MB)'
col "SIZE(GB)" FORMAT 9,999.990 HEADING 'SIZE(GB)'
col "SIZE(TB)" FORMAT 9,999.990 HEADING 'SIZE(TB)'
col name for a40
select name
  , open_mode
  , restricted
  ...
  , to_char(total_size/1024/1024,           '999,999.990') AS "SIZE(MB)"
  , to_char(total_size/1024/1024/1024,      '999,999.990') AS "SIZE(GB)"
  , to_char(total_size/1024/1024/1024/1024, '999,999.990') AS "SIZE(TB)"
from v$containers 
