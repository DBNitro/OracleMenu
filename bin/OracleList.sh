...
if [[ "$(uname)" == "SunOS" ]]; then
  ...
  CRSD_PROC="$(ps -ef                   | egrep -i -v 'grep|egrep|sed'                           | egrep -i 'crsd.bin'            | uniq                         | sort               | wc -l             | xargs)"
  ORDS_PROC="$(ps -ef                   | egrep -i -v 'grep|egrep|sed'                           | egrep -i 'ords.war'            | uniq                         | sort               | wc -l             | xargs)"
  OCSSD_PROC="$(ps -ef                  | egrep -i -v 'grep|egrep|sed'                           | egrep -i 'ocssd.bin'           | uniq                         | sort               | wc -l             | xargs)"
  OHASD_PROC="$(ps -ef                  | egrep -i -v 'grep|egrep|sed'                           | egrep -i 'ohasd.bin'           | uniq                         | sort               | wc -l             | xargs)"
  LISTENER_PROC="$(ps -ef               | egrep -i -v "grep|egrep|sed|zabbix|webmin"             | egrep -i "listener"            | awk '{ print $9 }'           | uniq               | sort              | wc -l | xargs)"
  ...
  DGOBS_PROC="$(ps -ef                  | egrep -i -v 'grep|egrep|sed'                           | egrep -i 'observer'            | uniq                         | sort               | wc -l             | xargs)"
  AGENT_PROC="$(ps -ef                  | egrep -i -v "grep|egrep|set|zabbix|webmin"             | egrep -i "agent_|perl"         | uniq                         | sort               | wc -l             | xargs)"
  OMS_PROC="$(ps -ef                    | egrep -i -v "grep|egrep|set|zabbix|webmin"             | egrep -i "wlserver"            | uniq                         | sort               | wc -l             | xargs)"
  WLS_PROC="$(ps -ef                    | egrep -i -v "grep|egrep|set|zabbix|webmin"             | egrep -i "wlserver"            | uniq                         | sort               | wc -l             | xargs)"
  OGG_PROC="$(ps -ef                    | egrep -i -v "grep|egrep|set|zabbix|qmgr|clmgrs|dgmgrl" | egrep -i "mgr|prm"             | uniq                         | sort               | wc -l             | xargs)"
  ...
  DATABASE_PROC="$(ps -ef               | egrep -i -v "grep|egrep|sed"                           | egrep -i "ora_pmon|db_pmon"    | awk '{ print $NF }'          | sed s/ora_pmon_//g | sed s/db_pmon_//g | uniq  | sort  | wc -l | xargs)"
  DGOBS_PROC="$(ps -ef                  | egrep -i -v 'grep|egrep|sed'                           | egrep -i 'observer'            | uniq                         | sort               | wc -l             | xargs)"
  AGENT_PROC="$(ps -ef                  | egrep -i -v "grep|egrep|sed|zabbix|webmin"             | egrep -i "agent_|perl"         | uniq                         | sort               | wc -l             | xargs)"
  OMS_PROC="$(ps -ef                    | egrep -i -v "grep|egrep|sed|zabbix|webmin"             | egrep -i "wlserver"            | uniq                         | sort               | wc -l             | xargs)"
  WLS_PROC="$(ps -ef                    | egrep -i -v "grep|egrep|sed|zabbix|webmin"             | egrep -i "wlserver"            | uniq                         | sort               | wc -l             | xargs)"
  OGG_PROC="$(ps -ef                    | egrep -i -v "grep|egrep|sed|zabbix|qmgr|clmgrs|dgmgrl" | egrep -i "mgr|prm"             | uniq                         | sort               | wc -l             | xargs)"
  MYSQL_PROC="$(ps -ef                  | egrep -i -v "grep|egrep|sed"                           | egrep -i "bin/mysqld"          | awk '{ print $NF }'          | sort               | wc -l             | uniq | xargs)"
  PSQL_PROC="$(ps -ef                   | egrep -i -v "grep|egrep|sed"                           | egrep -i "bin/postgres"        | awk '{ print $NF }'          | sort               | wc -l             | uniq | xargs)"
  DB2_PROC="$(ps -ef                    | egrep -i -v "grep|egrep|sed"                           | egrep -i "ibm/db2"             | awk '{ print $NF }'          | sort               | wc -l             | uniq | xargs)"
  ASM_HOME="$(cat ${ORA_INVENTORY}      | egrep -i -v "${ORA_HOMES_IGNORE_1}"                    | egrep -i "LOC"                 | egrep -i "OraGI|CRS="        | awk '{ print $3 }' | cut -f2 -d '='    | cut -f2 -d '"' | uniq | sort)"
...
if [[ "${ASM_PROC}" != "0" ]]; then
  ...
  ASM_STARTED="$(ps -ef | egrep -i -v "grep|egrep|sed" | egrep -i "asm_pmon" | awk '{ print $5 }'     | uniq                         | tail -2)"
    ASM_HOMES="$(ps -ef | egrep -i -v "grep|egrep|sed" | egrep -i "oraagent.bin" | awk '{ print $8 }' | sed 's#/bin/oraagent\.bin##' | uniq)"
  ...
  if [[ "${DATABASE_PROC}" != "0" ]]; then
    for DATABASE_SERVICE in $(ps -ef | egrep -i -v "grep|egrep|sed" | egrep -i "ora_pmon|db_pmon" | awk '{ print $NF }' | sed s/ora_pmon_//g | sed s/db_pmon_//g | uniq | sort); do
      if [[ $(cat ${ORATAB} | egrep -v "^#|^$" | awk '{ print $1 }' | cut -f1 -d ':' | sed 's/_.*//' | egrep -w "${DATABASE_SERVICE}") != ${DATABASE_SERVICE} ]]; then
        ...
        printf "|%-31s|%-31s|%-31s|%-60s|\n" " ${DATABASE_SERVICE} ${DATABASE_ROLE} " " RUNNING " " UP SINCE: ${DATABASE_STARTED} " " ${DATABASE_TYPE} "
        printf "+%-31s+%-31s+%-31s+%-50s+\n" "-------------------------------" "-------------------------------" "-------------------------------" "------------------------------------------------------------"
      else
ORAENV_ASK=NO
...
# DATABASE STARTED UP
#
DATABASE_STARTED="$(echo "select to_char(startup_time, 'YYYY-MM-DD HH24:MI') from v\$instance;" | sqlplus -S / as sysdba | tail -2)"
#
# DB RESULT
#
      printf "|%-31s|%-31s|%-31s|%-60s|\n" " ${DATABASE_SERVICE} ${DATABASE_ROLE} " " ${DATABASE_STATUS} ${DATABASE_MODE} " " UP SINCE: ${DATABASE_STARTED} " " ${ORACLE_HOME}"
      printf "+%-31s+%-31s+%-31s+%-50s+\n" "-------------------------------" "-------------------------------" "-------------------------------" "------------------------------------------------------------"
    fi
    done
  fi
